...
namespace Bibliotheek_Console
{
    ...
    public class Boek
    {
        ...
        public Boek(string title, string author, string publisher, string releaseDate, Genre genre)
        {
            BookTitle = title;
            BookAuthor = author;
        ...
        // boek zonder publisher
        public Boek (string title, string author, string releaseDate, Genre genre)
        {
            BookTitle = title;
            BookAuthor = author;
            ReleaseDate = releaseDate;
        ...
        public string ToString()
        {
            ...
            return ("Titel van Boek: " + BookTitle + "Auteur: " + BookAuthor + "Genre" + Genre  + "Publicatiedatum" + ReleaseDate);
